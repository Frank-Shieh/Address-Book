...
public class NewPersonAdapterAddress extends CustomAdapter {
	...
	public NewPersonAdapterAddress(Context context, int layout,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			vh.mData = (EditText) convertView
					.findViewById(R.id.newperson_address_entertext);
...
//			vh.mData.setOnFocusChangeListener(new FocusChange());
			...
			vh.mSpinner = (Spinner) convertView
					.findViewById(R.id.newperson_address_spinner);
